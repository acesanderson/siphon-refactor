...
from siphon_server.sources.drive.extractor import DriveExtractor
from siphon_server.sources.drive.enricher import DriveEnricher
...
class TestDriveParser:
    ...
    def test_parse_creates_correct_uri(self, parser):
        # TODO: Verify URI format is "drive:///{identifier}"
...
class TestDriveExtractor:
    ...
    def extractor(self):
        ...
        return DriveExtractor(client=None)
...
class TestDriveEnricher:
    @pytest.fixture
    def enricher(self):
        # TODO: Mock LLM client
        return DriveEnricher(llm=None)
